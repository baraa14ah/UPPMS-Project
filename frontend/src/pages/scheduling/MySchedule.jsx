    ...
    <>
      ...
      >
        ...
        >
          ...
          <IconButton size="small" sx={{ flexShrink: 0 }} tabIndex={-1}>
        ...
        <Stack
          ...
          gap={0.75}
          useFlexGap
          sx={{ mt: 1.25, minWidth: 0, maxWidth: "100%" }}
        >
          <Chip size="small" label={session.scheduled_time || "—"} sx={{ fontWeight: 800, maxWidth: "100%" }} />
          {session.room?.name && (
            <Chip
              size="small"
              color="primary"
      ...
      <Dialog open={open} onClose={() => setOpen(false)} fullWidth maxWidth="xs">
        <DialogTitle sx={{ fontWeight: 900, pb: 1 }}>
          {session.project?.title || t("scheduling.generate.candidate.sessionDetails")}
        </DialogTitle>
          ...
          <Stack spacing={1.5}>
            ...
            <Stack direction="row" flexWrap="wrap" gap={0.75} useFlexGap>
              ...
              {session.formatted_date || session.scheduled_date ? (
                <Chip
                  size="small"
                  variant="outlined"
                  label={session.formatted_date || session.scheduled_date}
                />
              ) : null}
              <ResultChip session={session} t={t} />
            </Stack>
            ...
            <Box>
              ...
              <Stack direction="row" flexWrap="wrap" gap={0.5} useFlexGap>
                {(session.committee_members || []).length === 0 ? (
                  <Typography variant="body2" color="text.secondary">
                    —
                  </Typography>
                ) : (
        ...
        <DialogActions sx={{ px: 2.5, py: 1.5, justifyContent: "flex-start", flexWrap: "wrap", gap: 1 }}>
...
export default function MySchedule() {
  ...
  return (
    <Box sx={{ p: { xs: 2, md: 3 }, maxWidth: 1400, mx: "auto", width: "100%", minWidth: 0, boxSizing: "border-box" }}>
      <PageHeader
