                ...
                return (
                  ...
                  >
                    <Stack direction="row" justifyContent="space-between" spacing={1} sx={{ minWidth: 0 }}>
                      ...
                      {flagged && <WarningAmber fontSize="small" color="warning" sx={{ flexShrink: 0 }} />}
                    </Stack>
                    <Stack
                      direction="row"
                      flexWrap="wrap"
  ...
  return (
    <>
      ...
      >
        ...
        {/* White body */}
        <Box sx={{ p: { xs: 1.5, sm: 2.5 }, bgcolor: "#fff", minWidth: 0, maxWidth: "100%", overflow: "hidden" }}>
          <Alert
          ...
          {tab === 0 && (
            <Stack spacing={1.5} sx={{ minWidth: 0, maxWidth: "100%", overflow: "hidden" }}>
              <Stack
